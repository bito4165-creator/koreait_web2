...
public class ProductJdbcImpl implements ProductRepository {
    ...
    // 인터페이스타입으로 캐스팅해서 타입을 통일하고, 오버라이딩된 메서드 호출됨
    ...
    public int deleteProductById(int id) {
        String sql = "delet form product where product_id = ?";
        Connection conn = null;
        PreparedStatement ps = null;
        ...
        try {
            ...
            log.error("deleteProduct 실패 - {}", id, e);
    ...
    public int updateProductById(Product product) {
        ...
        try {
            ...
            log.error("updateProduct 실패 - {}", product, e);
